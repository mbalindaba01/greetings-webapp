...
let NamesGreeted = require('../namesGreeted')
...
describe('NamesGreeted Function', () => {
    describe('Set Values', () => {
        it('should be able to set the name to zuki', () => {
            ...
            assert.strictEqual('zuki', greetedNames.getName())
        });
        ...
        it('should transform Mbali to mbali', () => {
            ...
            assert.strictEqual('mbali', greetedNames.getName())
        });
        ...
        it('should transform SIYABONGA to siyabonga', () => {
            ...
            assert.strictEqual('siyabonga', greetedNames.getName())
        });
